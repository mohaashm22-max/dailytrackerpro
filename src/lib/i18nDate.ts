...
import {
  ...
  et, lv, lt, ca, gl, eu, af, sq, az, bs, mk, mt, is, ga, cy, mn, ne, si,
  ka, hy, kk, uz, kn, ml, ta, te,
} from "date-fns/locale";

const LOCALES: Record<string, Locale> = {
  en: enUS, ar, es, fr, de, it, pt, ru, zh: zhCN, ja, ko, hi, tr, id, ms,
  vi, th, nl, pl, uk, sv, no: nb, da, fi, he, fa: faIR, ro, cs, sk, hu, el,
  bg, hr, sr, sl, et, lv, lt, ca, gl, eu, af, sq, az, bs, mk, mt, is, ga,
  cy, mn, ne, si, ka, hy, kk, uz, kn, ml, ta, te,
};
